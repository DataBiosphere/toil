...
def exportTopicTreeSpec(moduleName: str = ..., rootTopic: Union[Topic, str] = ..., bak: str = ..., moduleDoc: str = ...): ...

class TopicTreeSpecPrinter:
    INDENT_CH: str
    def __init__(self, rootTopic: Union[str, Topic] = ..., fileObj: TextIO = ..., width: int = ..., indentStep: int = ..., treeDoc: str = ..., footer: str = ...): ...
