...
"autoscale", creating and terminating workers as needed to meet the demands of the workflow. Historically, Toil spins
up clusters with `Apache Mesos`_, but it is no longer the recommended way to coordinate and execute tasks within the
workflow.
