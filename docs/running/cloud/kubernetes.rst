...
Running CWL workflows on Kubernetes can be challenging, because executing CWL can require Toil to orchestrate containers of its own, within a Kubernetes job running in the Toil appliance container.
