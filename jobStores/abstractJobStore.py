...
class AbstractJobStore( object ):
    ...
    def __init__( self, jobStoreString, create=False, config=None ):
        ...
        """
        # This will be none until "loadJobTree" is called.
        self.jobTreeState = None
    ...
    def readStats( self, fileHandle ):
        """
        Reads stats strings accumulated by "writeStats" function, writing each one to the given
        fileHandle. Returns the number of stat strings processed. Stats are only read once.
        """
        raise NotImplementedError( )
