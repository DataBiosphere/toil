...
from jobTree.batchSystems.mesos import JobTreeJob, ResourceRequirement, TaskData
from jobTree.batchSystems.mesos.badExecutor import BadMesosExecutor
from jobTree.batchSystems.mesos.executor import MesosExecutor
...
class MesosBatchSystem(AbstractBatchSystem, mesos.interface.Scheduler):
    ...
    def buildExecutor(self, bad):
        ...
        if bad:
            ...
            executorInfo.executor_id.value = "jobTreeExecutor"
    ...
    def _createTask(self, jt_job, offer):
        """
        Build the Mesos task object from the jobTree job here to avoid further cluttering resourceOffers
        """
