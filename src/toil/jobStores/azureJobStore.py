...
class AzureJobStore(AbstractJobStore):
    ...
    def writeStatsAndLogging(self, statsAndLoggingString):
        ...
        self.statsFiles.create_blob_from_text(blob_name=jobStoreFileID,
    ...
    def getPublicUrl(self, jobStoreFileID):
        ...
        sas_token = self.files.generate_blob_shared_access_signature(blob_name=jobStoreFileID,
    ...
    def _uploadStream(self, jobStoreFileID, container, checkForModification=False, encrypted=None):
        ...
        if checkForModification:
            try:
                expectedVersion = container.get_blob_properties(blob_name=jobStoreFileID).properties.etag
            except AzureMissingResourceHttpError:
        ...
        class UploadPipe(WritablePipe):
            ...
            def readFrom(self, readable):
                ...
                if checkForModification and expectedVersion is not None:
                    ...
                    leaseID = container.acquire_blob_lease(blob_name=jobStoreFileID,
                                                           lease_duration=60)
                    # check for modification,
                    blob = container.get_blob_properties(blob_name=jobStoreFileID)
                    if blob.properties.etag != expectedVersion:
                        container.release_blob_lease(blob_name=jobStoreFileID, lease_id=leaseID)
        ...
        class DownloadPipe(ReadablePipe):
            def writeTo(self, writable):
                ...
                while chunkStart < fileSize:
                    ...
                    buf = container.get_blob_to_bytes(blob_name=jobStoreFileID,
...
class AzureJob(JobGraph):
    ...
    def toEntity(self, chunkSize=maxAzureTablePropertySize):
        ...
        item['RowKey'] = self.jobStoreID
        item['PartitionKey'] = AzureTable.defaultPartition
        return Entity(item)
