...
class Resource(namedtuple('Resource', ('name', 'pathHash', 'url', 'contentHash'))):
    ...
    def lookup(cls, leaderPath):
        ...
        file or directory on the worker, it only identifies the resource within an instance of toil. This method
...
class ModuleDescriptor(namedtuple('ModuleDescriptor', ('dirPath', 'name', 'extension'))):
    ...
    def belongsToToil(self):
        ...
        """
        # FIXME: Forcing this to False for now to give this code more exposure but once we hot-deploy toil itself
        # FIXME: ... it should be used to shortcut hot-deployment for user scripts inside the toil distribution.
