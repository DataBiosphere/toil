...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with zipfile.ZipFile('ENCODE_data.zip', 'r') as zip_ref:
            zip_ref.extractall('.')
        with zipfile.ZipFile('GATK_data.zip', 'r') as zip_ref:
            zip_ref.extractall('.')
        with zipfile.ZipFile('toil_templates.zip', 'r') as zip_ref:
            zip_ref.extractall('.')
        with zipfile.ZipFile('wdl_templates.zip', 'r') as zip_ref:
            zip_ref.extractall('.')
    ...
    def testENCODE(self):
        ...
        a short ENCODE run.'''
        wdl = "wdl_templates/testENCODE/encode_mapping_workflow.wdl"
        json = "wdl_templates/testENCODE/encode_mapping_workflow.wdl.json"
        tutorial_good_output_dir = 'wdl_templates/testENCODE/output/'
    ...
    def testCSV(self):
        ...
        t = ToilWDL("wdl_templates/t01/helloHaplotypeCaller.wdl",
                    "wdl_templates/t01/helloHaplotypeCaller_inputs.json",
                    "toil_outputs")
        csv_array = t.create_csv_array('test.csv')
    ...
    def testTSV(self):
        ...
        t = ToilWDL("wdl_templates/t01/helloHaplotypeCaller.wdl",
                    "wdl_templates/t01/helloHaplotypeCaller_inputs.json",
                    "toil_outputs")
        tsv_array = t.create_tsv_array('test.tsv')
    ...
    def testJSON(self):
        ...
        t = ToilWDL("wdl_templates/t01/helloHaplotypeCaller.wdl",
                    "wdl_templates/t01/helloHaplotypeCaller_inputs.json",
                    "toil_outputs")
        json_dict = t.dict_from_JSON("wdl_templates/t01/helloHaplotypeCaller_inputs.json")
