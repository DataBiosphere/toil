...
from toil.lib.aws.credentials import iam_boto3_client
...
@retry(errors=[iam_boto3_client.exceptions.NoSuchEntityException])
def wait_until_instance_profile_arn_exists(instance_profile_arn: str):
    ...
    iam_boto3_client.get_instance_profile(InstanceProfileName=instance_profile_name)
