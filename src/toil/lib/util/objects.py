...
from toil.lib.util import sync_memoize
...
class InnerClass( object ):
    ...
    >>> i = o.new_inner()
    >>> i # doctest: +ELLIPSIS
    <toil.lib.util.objects.Inner object at ...> bound to <toil.lib.util.objects.Outer object at ...>
    ...
    <toil.lib.util.objects.DerivedInner object at ...> bound to <toil.lib.util.objects.DerivedOuter object at ...>
