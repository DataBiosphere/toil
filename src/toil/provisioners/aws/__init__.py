...
def get_best_aws_zone(
    ...
    boto2_ec2: Optional["boto.connection.AWSAuthConnection"] = None,
    ...
    return (
        ...
        or get_aws_zone_from_spot_market(spotBid, nodeType, boto2_ec2, zone_options)
...
def _get_spot_history(boto2_ec2, instance_type):
    ...
    spot_data = boto2_ec2.get_spot_price_history(
