...
class AWSProvisioner(AbstractProvisioner):
    ...
    def _discoverAMI(self):
        def descriptionMatches(ami):
            return ami.description is not None and 'stable 1800.7.0' in ami.description
        ...
        for attempt in retry(predicate=lambda e: isinstance(e, SSLError)):
            ...
            with attempt:
                ...
                amis = self._ctx.ec2.get_all_images(owners=['679593333241'], filters={'name': 'CoreOS-stable-1800.7.0-hvm-0d1e0bd0-eaea-4397-9a3a-c56f861d2a14-ami-00cc4337762ba4a52.4'})
