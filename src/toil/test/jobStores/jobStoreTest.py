...
class AbstractJobStoreTest:
    ...
    class Test(ToilTest, metaclass=ABCMeta):
        ...
        def test_file_hints(self) -> None:
            ...
            assert edit_distance.edit_distance(many_hint_id, other_many_hint_id) < 3, "IDs using hints must be low-entropy and human-findable, while not colliding even across nodes!"
