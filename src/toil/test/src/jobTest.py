...
class TestJob:
    ...
    @slow
    @pytest.mark.slow
    def testNewCheckpointIsLeafVertexNonRootCase(self, tmp_path: Path) -> None:
        """
        ...
        self.runNewCheckpointIsLeafVertexTest(tmp_path, createWorkflow)

    @slow
    @pytest.mark.slow
    def testNewCheckpointIsLeafVertexRootCase(self, tmp_path: Path) -> None:
        """
    ...
    def runNewCheckpointIsLeafVertexTest(
        self, tmp_path: Path, createWorkflowFn: Callable[[], tuple[Job, Job]]
    ) -> None:
        """
        ...
        self.runCheckpointVertexTest(
            *createWorkflowFn(), tmp_path=tmp_path, expectedException=None
        )
