...
def make_tests(generalMethod: Callable[[Any], Any], targetClass: Optional[Callable[[Any], Any]], **kwargs: Any) -> None:
    """
    ...
    def permuteIntoLeft(left: dict[str, dict[str, str]], rParamName: str, right: dict[str, str]) -> None:
        """
