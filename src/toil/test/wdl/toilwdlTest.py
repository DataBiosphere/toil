...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with zipfile.ZipFile('src/toil/test/wdl/ENCODE_data.zip', 'r') as zip_ref:
            zip_ref.extractall('src/toil/test/wdl/')
        with zipfile.ZipFile('src/toil/test/wdl/GATK_data.zip', 'r') as zip_ref:
            zip_ref.extractall('src/toil/test/wdl/')
        with zipfile.ZipFile('src/toil/test/wdl/wdl_templates.zip', 'r') as zip_ref:
            zip_ref.extractall('src/toil/test/wdl/')
    ...
    def testTut01(self):
        ...
        GATK tutorial #1.'''
        wdl = "src/toil/test/wdl/wdl_templates/t01/helloHaplotypeCaller.wdl"
        json = "src/toil/test/wdl/wdl_templates/t01/helloHaplotypeCaller_inputs.json"
    ...
    def testTut02(self):
        '''Test if toilwdl produces the same outputs as known good outputs for WDL's
        GATK tutorial #2.'''
        wdl = "src/toil/test/wdl/wdl_templates/t02/simpleVariantSelection.wdl"
        json = "src/toil/test/wdl/wdl_templates/t02/simpleVariantSelection_inputs.json"
    ...
    def testTut03(self):
        '''Test if toilwdl produces the same outputs as known good outputs for WDL's
        GATK tutorial #3.'''
        wdl = "src/toil/test/wdl/wdl_templates/t03/simpleVariantDiscovery.wdl"
        json = "src/toil/test/wdl/wdl_templates/t03/simpleVariantDiscovery_inputs.json"
    ...
    def testTut04(self):
        '''Test if toilwdl produces the same outputs as known good outputs for WDL's
        GATK tutorial #4.'''
        wdl = "src/toil/test/wdl/wdl_templates/t04/jointCallingGenotypes.wdl"
        json = "src/toil/test/wdl/wdl_templates/t04/jointCallingGenotypes_inputs.json"
    ...
    def testENCODE(self):
        ...
        a short ENCODE run.'''
        wdl = "src/toil/test/wdl/wdl_templates/testENCODE/encode_mapping_workflow.wdl"
        json = "src/toil/test/wdl/wdl_templates/testENCODE/encode_mapping_workflow.wdl.json"
    ...
    def testPipe(self):
        ...
        wdl = "src/toil/test/wdl/wdl_templates/testPipe/call.wdl"
        json = "src/toil/test/wdl/wdl_templates/testPipe/call.json"
    ...
    def testJSON(self):
        ...
        t = ToilWDL("src/toil/test/wdl/wdl_templates/t01/helloHaplotypeCaller.wdl",
                    "src/toil/test/wdl/wdl_templates/t01/helloHaplotypeCaller_inputs.json",
                    "src/toil/test/wdl/toil_outputs")
